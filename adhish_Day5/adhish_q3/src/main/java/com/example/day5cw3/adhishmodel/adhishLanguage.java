package com.example.day5cw3.adhishmodel;

import jakarta.persistence.Entity;
import jakarta.persistence.Id;

@Entity
public class adhishLanguage {
    @Id
    private int languageId;
    private String languageName;
    private String languageComplexity;
    public adhishLanguage() {
    }
    public adhishLanguage(int languageId, String languageName, String languageComplexity) {
